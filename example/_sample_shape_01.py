...
DATA_PATH = 'G:/.shortcut-targets-by-id/19j2p-s21q1pYuoGXuk11Bu934R1tS8MU/' \
            'MAS Thesis 2020/3_Prototype/000_Exploration/07_branch_data_structure/data_simple_shape/'

if __name__ == "__main__":
    pts_list_data = utils.load_from_Json(DATA_PATH, "pts_list_data.json")

    Skeleton = skeleton_data.create_data_from_pts(pts_list_data)
